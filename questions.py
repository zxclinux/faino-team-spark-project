from queries import (
    ...
    q19_top5_businesses_per_city,
    q20_rating_trend_first_vs_last_year,
    q21_top_categories_by_tips,
    q22_top10_categories_by_avg_rating,
    q23_top10_users_by_useful_votes,
    q24_elite_users_most_funny_reviews,
)

DMYTRO = "Dmytro Korolchuk"
DMYTRO_OUT = "/data/output/dk"

YAROSLAV = "Yaroslav Vasylyshyn"
YAROSLAV_OUT = "/data/output/yv"

YURII = "Yurii Sirenko"
YURII_OUT = "/data/output/ys"

ROMAN = "Роман Стожук"
ROMAN_OUT = "/data/output/rs"
...
QUESTIONS.append(Question(
    ...
    q1_top3_restaurants_per_state,
    author=DMYTRO, output_dir=DMYTRO_OUT,
))
...
QUESTIONS.append(Question(
    ...
    q7_active_reviewers_vs_all_avg_rating,
    author=YAROSLAV, output_dir=YAROSLAV_OUT,
))
...
QUESTIONS.append(Question(
    ...
    q13_monthly_review_growth,
    author=YURII, output_dir=YURII_OUT,
))
...
QUESTIONS.append(Question(
    "19. Топ-5 бізнесів за зірковим рейтингом у кожному місті",
    q19_top5_businesses_per_city,
    author=ROMAN, output_dir=ROMAN_OUT,
))

QUESTIONS.append(Question(
    "20. Тренд рейтингу: середня оцінка за перший vs останній рік відгуків",
    q20_rating_trend_first_vs_last_year,
    author=ROMAN, output_dir=ROMAN_OUT,
))

QUESTIONS.append(Question(
    "21. Категорії бізнесу з найбільшою кількістю tips",
    q21_top_categories_by_tips,
    author=ROMAN, output_dir=ROMAN_OUT,
))

QUESTIONS.append(Question(
    "22. Топ-10 категорій за середнім рейтингом (≥50 бізнесів)",
    q22_top10_categories_by_avg_rating,
    author=ROMAN, output_dir=ROMAN_OUT,
))

QUESTIONS.append(Question(
    "23. Топ-10 користувачів за сумою useful-голосів на їхніх відгуках",
    q23_top10_users_by_useful_votes,
    author=ROMAN, output_dir=ROMAN_OUT,
))

QUESTIONS.append(Question(
    "24. Elite-користувачі з найбільшою кількістю funny-відгуків",
    q24_elite_users_most_funny_reviews,
    author=ROMAN, output_dir=ROMAN_OUT,
))
